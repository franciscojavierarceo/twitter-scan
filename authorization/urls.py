...
urlpatterns = [
    ...
    path("users-searched/", views.SearchedTwitterUsersListView.as_view(), name="user_search_history"),
    path("result-list/tu/<int:tuid>/", views.SearchedTweetsDetailView.as_view(), name="tu_result_list"),
